<template>
  <div class="text-lightgray font-montserrat w-screen flex gap-6 justify-center p-8 pb-2">
    <a target="_blank" href="https://github.com/QuetzalCtrl">
      <button class=" p-2 font-semibold text-green inline-flex items-center space-x-2 rounded">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="w-12 h-12" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
    ...
    <a target="_blank" href="https://www.linkedin.com/in/hugo-vanrobaeys">
      <button class="p-2 font-semibold text-green inline-flex items-center space-x-2 rounded">
        <svg class="w-12 h-12 fill-current" role="img" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
